...
$(document).ready(function () {
    ...
    $.getJSON("packages/" + dPackage + ".json", function (data) {
        ...
        var extra = {
            "<img class=\"icon\" src=\"icons/twitter.png\"><span>Theo dõi Twitter (@tqmmos)</span>": "https://twitter.com/aminhdz",
            "<img class=\"icon\" src=\"icons/email.png\"><span>Hỗ trợ qua email</span>": "mailto:anhminh311105@gmail.com",
